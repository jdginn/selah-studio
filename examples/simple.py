...
class parameters:
    ...
    speaker_height: float = 1.86
    dist_from_wall: float = 0.516
    # dist_from_center: float = 1.1
    dist_from_center: float = 1.35
    # deviation_from_equilateral: float = 0.3
    deviation_from_equilateral: float = -0.12
    max_listen_pos: float = 2.7
    min_listen_pos: float = 1.3
    ceiling_diffuser_height: float = 2.41
    ceiling_diffuser_length: float = 2.43
    ceiling_diffuser_width: float = 3.9
    # ceiling_diffuser_position: float = 0.75
    ceiling_diffuser_position: float = 0.6
